...
%                 % basically you scroll over u with a constant window of width nnx i.e. you're taking one mode at a time
%                 % remember that u is a column vector coming from A u = b of (dimension nnx * numb_modes, 1)
%                 % THIS LOOP VERY MUCH LIKELY BRINGS THE PROBLEM FROM THE REFERENCE DOMAIN IN DIRECTION X TO THE REAL 
%                 % DOMAIN IN DIRECTION (TRANSLATION) X WHILE DIRECTION Y STAYS FIXED
% 
%             end
% 
%             % COMPUTATION OF THE NURBS BASE
% 
%             u  = approx'; % approx is a grid of points in direction x corresponding to the physical domain in direction x
%                           % where u has been evaluated
% 
